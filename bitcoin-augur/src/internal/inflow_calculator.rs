...
impl InflowCalculator {
    ...
    pub fn calculate_inflows(
        ...
        if total_time_span.num_seconds() > 0 {
            ...
            let normalization_factor = ten_minutes.num_seconds() as f64 / 
                                      total_time_span.num_seconds() as f64;
...
mod tests {
    ...
    fn test_empty_snapshots() {
        let inflows = InflowCalculator::calculate_inflows(
            &[],
            Duration::hours(24),
        );
